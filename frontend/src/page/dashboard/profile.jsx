...
const Profile = () => {
  ...
  const items = [
    {
      ...
      label: (
        <button
          ...
          className="px-3 bg-teal-500 rounded-xl w-full py-1 text-white hover:bg-teal-600 text-sm"
        >
    ...
    },
    {
      ...
      label: (
        <button
          ...
          className="px-3 bg-red-500 rounded-xl w-full py-1 text-white hover:bg-red-600"
        >
  ...
  return (
      ...
      <div className="flex flex-col items-center w-full min-h-screen p-2 lg:p-10 bg-gradient-to-r from-teal-50 to-white">
        <h2 className="m-5 lg:m-10 text-3xl lg:text-5xl font-bold text-center text-teal-600">
          My Profile
        </h2>
        <div className="flex flex-col w-full max-w-5xl p-4 lg:p-8 space-y-2 lg:space-y-10 bg-white shadow-xl rounded-3xl">
          <Spin spinning={loading}>
            <div className="flex justify-center">
              <Avatar
                ...
                className="border-4 border-teal-300 shadow-lg cursor-pointer"
              />
              <div className="relative flex justify-center items-center top-2 -left-7 bg-white w-8 h-8 rounded-full cursor-pointer text-teal-800 hover:text-teal-600">
                <Dropdown menu={{ items }} trigger={"hover"} arrow size="small">
          ...
          <div className="text-center">
            <h3 className="text-lg lg:text-4xl font-semibold text-teal-700 uppercase">
              {mentorData?.name}
            </h3>
            <p className="flex items-center justify-center mt-4 text-sm lg:text-lg text-gray-700">
              <AiOutlineMail className="mr-2 text-teal-500" />
              {mentorData?.email}
            </p>
            <p className="flex items-center justify-center mt-2 text-sm lg:text-lg text-gray-700">
              <AiOutlineUser className="mr-2 text-teal-500" />
              {mentorData?.profile?.title}
            </p>
          </div>
          <div className="mt-2 text-lg text-gray-700">
            <span className="text-sm lg:text-xl text-teal-400">Tags:</span>
            <div className="border border-teal-200 p-3 rounded-xl font-semibold text-md lg:text-2xl text-center">
              {" "}
              {mentorData?.profile?.tags?.join(" | ")}
            </div>
          </div>
          <div className="mt-4 text-lg text-gray-700">
            <span className="text-sm lg:text-xl text-teal-400">Bio:</span>
            <div className="border border-teal-200 p-5 rounded-xl text-sm lg:text-xl text-justify">
              {" "}
              {mentorData?.profile?.bio}
            </div>
          </div>
          {mentorData?.profile?.college && (
            <div className="pt-2 text-sm lg:text-lg text-gray-700">
              <span className="text-sm lg:text-xl text-teal-400">College:</span>
              <div className="border border-teal-200 p-3 rounded-xl text-sm lg:text-xl mt-1 text-center">
                {" "}
                {mentorData?.profile?.college}
              </div>
            </div>
          ...
          <h3 className="text-xl lg:text-2xl font-semibold text-center text-teal-700 pt-3">
            Connect with Me
          </h3>
          <div className="flex justify-center space-x-2 lg:space-x-6 pb-3">
            <a
            ...
            >
              <AiFillLinkedin className="text-2xl lg:text-4xl" />
            </a>
            <a
            ...
            >
              <AiFillGithub className="text-2xl lg:text-4xl" />
            </a>
            <a
            ...
            >
              <AiFillTwitterCircle className="text-2xl lg:text-4xl" />
            </a>
            <a
            ...
            >
              <AiFillFacebook className="text-2xl lg:text-4xl" />
            </a>
            <a
            ...
            >
              <AiFillInstagram className="text-2xl lg:text-4xl" />
            </a>
          </div>

          <button
            className="w-full text-lg bg-teal-500 text-white rounded-lg hover:bg-teal-600 transition-all py-1 lg:py-2"
