    ...
    <div className="border rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      >
        {service.courseType === "one-on-one" ? (
                ...
                {availableSlots.map((slot, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      onClick={() =>
                        !isBooked && handleSlotSelect(slot, service)
                      }
          ...
          <div>
            <p>
              This is a {service.courseType} service running from{" "}
              {new Date(service.fromDate).toLocaleDateString()} to{" "}
              {new Date(service.toDate).toLocaleDateString()}.
            </p>
            <p className="mt-2">
              Scheduled days: {service.fixedDays.join(", ")} at{" "}
