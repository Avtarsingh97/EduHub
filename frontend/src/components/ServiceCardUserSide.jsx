...
const ServiceCardUserSide = ({ service, username }) => {
  ...
  return (
    <>
      <div className="p-4 bg-gray-100 shadow-2xl cursor-pointer group rounded-2xl">
        <div className="py-2 text-2xl font-bold lg:pb-5 text-teal-800">{service?.serviceName}</div>
        <div className="text-sm pb-2 lg:pb-5 text-gray-600">{service?.description}</div>
