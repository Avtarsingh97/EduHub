...
function Nav() {
  ...
  const items = [
    {
      ...
      label: (
        <NavLink to="/dashboard/profile">
          <p className="py-2 bg-teal-600 rounded-md text-white px-5 text-2xl font-medium">
            Dashboard
          </p>
        </NavLink>
      ),
  ...
  return (
    <>
      <div
        className={` sticky top-0 z-50 py-1 transition-all duration-500 ${
          isScrolled ? "bg-teal-50" : "bg-white"
        }`}
      >
        <div className="px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-20">
          <div className="realtive flex items-center justify-between">
            <div className="flex items-center">
              <NavLink to="/" className="inline-flex items-center mr-8">
                <img
                  ...
                  alt="Mentorship Hub"
                />
                <span className="text-xl lg:text-4xl font-bold text-teal-700">
                  EduHub
                </span>
              </NavLink>
            </div>
            ...
            {!user ? (
              ...
              <Dropdown menu={{ items }} trigger={"hover"} arrow size="large">
                <button className="bg-teal-500 lg:px-4 lg:py-3 px-1 py-1 rounded-full hover:bg-teal-600 lg:text-4xl text-white font-semibold lg:w-[67px] text-xl w-[36px]">
